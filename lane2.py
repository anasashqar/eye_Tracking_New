...
import lane as edge  # Handles the detection of lane lines
...
class Lane:
    ...
    def get_line_markings(self, frame=None):
        ...
        _, s_binary = edge.threshold(s_channel, (90, 200))
        ...
        Mask = cv2.bitwise_not(r_thresh)

        cv2.imshow('king', Mask)
...
# ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        # lines.)
        rs_binary = cv2.bitwise_and(s_binary, Mask)
